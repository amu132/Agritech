        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
            ...
            <ul class="navbar-nav align-items-lg-center ml-auto topnav" id="nav">
                ...
                <li class="nav-item" id="prediction">
                    <div class="dropdown show">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-magic"></i> Prediction</span>
                        </a>
                ...
                <li class="nav-item" id="recommendation">
                    <div class="dropdown show">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-gavel"></i> Recommendation</span>
                        </a>
                        <div class="dropdown-menu">
                ...
                <li class="nav-item" id="trade">
                    <div class="dropdown show">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-shopping-cart"></i> Trade</span>
                        </a>
                        <div class="dropdown-menu">
                ...
                <!-- Combined Dropdown: Schemes & Insurance -->
                <li class="nav-item" id="services">
                    <div class="dropdown show">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text">
                                <i class="text-white fas fa-hand-holding-usd"></i> Schemes & Insurance
                            </span>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuServices">
                            <a class="dropdown-item" href="fschemes.php">
                                <i class="text-dark fas fa-scroll"></i> Government Schemes
                            </a>
                            <a class="dropdown-item" href="finsurance.php">
                                <i class="text-dark fas fa-shield-alt"></i> Insurance Plans
                            </a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item" id="tools">
                    <div class="dropdown show">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-gear"></i> Tools</span>
                        </a>
                        <div class="dropdown-menu">
                ...
                <li class="nav-item" id="profile">
                    <?php $para2 = isset($para2) ? $para2 : 'User'; ?>
                    <a href="fprofile.php" class="nav-link">
                        <span class="text-white nav-link-inner--text font-weight-bold">
                            <i class="text-white fas fa-user"></i> <?php echo $para2 ?> 
                        </span>
                    </a>
                </li>
